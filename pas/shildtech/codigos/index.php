<html>
  ...
  <body>
    <header class="header">
      <div></div>
      <div></div>
      <div class="h_separator">
        <div class="hs_button">
          <span>Suporte</span>
        </div>
        <div class="hs_button">
          <span>Login</span>
          <link rel="stylesheet" herf="../codigos/Login.php">
    ...
    <main class="main">
      ...
      <div class="m_box_2">
        ...
        <div class="mb2_container">
          <div class="mb2c_container">
            ...
            <span>Ambiente seguro para nossos clientes e colaboradores</span>
          </div>
          <div class="mb2c_container">
      ...
      <div class="m_box">
        <span class="mb_title">Canais de contato</span>
        <div class="mb_container">
          ...
          <div class="mbc_container">
            ...
            <span class="mbcc_subtitle">Ajuda com nossos especialistas através do nosso canal oficial de WhatsApp.</span>
            <div class="mbcc_button">Clique Aqui</div>
          </div>
          <div class="mbc_container">
            <div class="mbcc_title">
            ...
            <span class="mbcc_subtitle">(45) 99154-1964</span>
            <span class="mbcc_subtitle">(45) 99816-2090</span>
          </div>
        </div>
      <div>
    </main>
    ...
    <script src="https://kit.fontawesome.com/4fc99b224c.js" crossorigin="anonymous"></script>
  </body>
</html>