...
--
-- Host: localhost
-- Tempo de geração: 12/06/2024 às 15:10
...
INSERT INTO `pessoa` (`cod_pessoa`, `cod_tipo`, `nome`, `telefone`, `email`, `senha`, `rua`, `cidade`, `numero_casa`, `bairro`) VALUES
...
--
ALTER TABLE `pessoa`
  ADD CONSTRAINT `pessoa_ibfk_1` FOREIGN KEY (`cod_tipo`) REFERENCES `tipo_pessoa` (`cod_tipo`);
COMMIT;
